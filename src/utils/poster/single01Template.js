...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { width: 1920px; height: 1080px; font-family: '宋体', 'SimSun', serif; background: #ffffff; overflow: hidden; }
    .poster { width: 1920px; height: 1080px; background: #fff; position: relative; border: 3px solid #61c5f2; overflow: hidden; }
    .content { position: absolute; top: 3px; left: 3px; right: 3px; bottom: 3px; display: flex; flex-direction: column; padding: 30px 50px; border: 2px solid #61c5f2; }
    ...
    .company-title { flex: 1; text-align: center; font-size: 72px; font-weight: bold; color: #61c5f2; letter-spacing: 8px; padding-right: 160px; }
    .info-table { width: 100%; border-collapse: collapse; margin-top: 25px; font-size: 32px; border: none; }
    .info-table td { border: 1px solid #61c5f2; padding: 18px 20px; color: #61c5f2; vertical-align: middle; text-align: center; font-weight: normal; font-size: 32px; line-height: 1.5; font-family: '宋体', 'SimSun', serif; }
    .info-table tr:first-child td { font-weight: bold; background: #f0f9ff; }
    ...
    .section-title { font-size: 32px; font-weight: bold; color: #61c5f2; margin-bottom: 10px; padding-left: 5px; font-family: '宋体', 'SimSun', serif; flex-shrink: 0; }
    .section-box { border: 2px solid #61c5f2; padding: 20px 24px; font-size: 32px; color: #61c5f2; line-height: 2; flex: 1; min-height: 0; font-weight: normal; font-family: '宋体', 'SimSun', serif; }
    .footer { margin-top: auto; display: flex; align-items: center; justify-content: space-between; padding: 20px 30px 10px; border-top: 2px solid #61c5f2; font-size: 32px; font-weight: normal; color: #61c5f2; font-family: '宋体', 'SimSun', serif; }
