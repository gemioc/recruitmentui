...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { width: 1920px; height: 1080px; font-family: '宋体', 'SimSun', serif; background: #ffffff; overflow: hidden; margin: 0; padding: 0; }
    .poster { width: 1920px; height: 1080px; background: #ffffff; position: relative; border: 8px solid #61c5f2; overflow: hidden; box-sizing: border-box; }
    ...
    .logo-placeholder { width: 140px; height: 140px; background: #f0f0f0; border: 2px dashed #61c5f2; border-radius: 8px; flex-shrink: 0; }
    .company-name { flex: 1; font-size: 72px; font-weight: bold; color: #61c5f2; letter-spacing: 4px; text-align: center; }
    .main-area { flex: 1; display: flex; overflow: hidden; }
    .left-table-area { flex: 1.8; display: flex; flex-direction: column; overflow: hidden; border: 1px solid #61c5f2; }
    .right-detail-area { flex: 1; display: flex; flex-direction: column; padding: 20px 30px; gap: 16px; overflow: hidden; border: 1px solid #61c5f2; }
    .job-table { width: 100%; height: 100%; border-collapse: collapse; table-layout: fixed; }
    .job-table thead { background: #f0f7fc; }
    .job-table thead th { height: 55px; font-size: 32px; color: #61c5f2; font-weight: bold; border: 1px solid #61c5f2; padding: 0; text-align: center; vertical-align: middle; font-family: '宋体', 'SimSun', serif; }
    .job-table tbody tr { height: 109px; }
    .job-table tbody td { font-size: 28px; color: #61c5f2; border: 1px solid #61c5f2; padding: 0; text-align: center; vertical-align: middle; font-weight: normal; line-height: 1.5; font-family: '宋体', 'SimSun', serif; }
    ...
    .detail-label { font-size: 32px; color: #61c5f2; font-weight: bold; text-align: left; flex-shrink: 0; font-family: '宋体', 'SimSun', serif; }
    .detail-section { flex: 1; display: flex; flex-direction: column; border: 1px solid #61c5f2; padding: 10px 14px; }
    .detail-content { flex: 1; font-size: 28px; color: #61c5f2; line-height: 1.5; word-break: break-word; text-align: left; overflow: hidden; font-weight: normal; font-family: '宋体', 'SimSun', serif; }
    .footer { height: 80px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 0 30px !important; margin: 0 !important; border-top: 1px solid #61c5f2 !important; font-size: 32px !important; font-weight: normal !important; color: #61c5f2 !important; background: transparent !important; box-sizing: border-box !important; flex-wrap: nowrap !important; overflow: visible !important; flex-shrink: 0 !important; font-family: '宋体', 'SimSun', serif !important; }
    ...
    .footer-label { color: #61c5f2 !important; font-size: 32px !important; font-weight: bold !important; font-family: '宋体', 'SimSun', serif !important; }
    .footer-value { color: #61c5f2 !important; font-size: 32px !important; font-weight: normal !important; margin-right: 8px !important; font-family: '宋体', 'SimSun', serif !important; }
