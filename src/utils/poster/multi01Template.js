...
function getCommonStyles() {
  return `
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .poster { width: 1920px; height: 1080px; max-height: 1080px; background: #ffffff; position: relative; border: 8px solid #61c5f2; overflow: hidden; box-sizing: border-box; }
    ...
    .logo-placeholder { width: 140px; height: 140px; background: #f0f0f0; border: 1px dashed #ccc; border-radius: 8px; }
    .company-name { flex: 1; text-align: center; font-size: 72px; font-weight: bold; color: #61c5f2; letter-spacing: 4px; padding-right: 160px; }
    ...
    .job-table th, .job-table td { border: 1px solid #61c5f2; padding: 0; text-align: center; vertical-align: middle; color: #61c5f2; }
    .job-table thead { background: #f0f7fc; }
    .job-table th { height: 65px; font-weight: bold; font-size: 32px; font-family: '宋体', 'SimSun', serif; }
    .job-table td { height: 130px; color: #61c5f2; text-align: center; font-weight: normal; font-size: 28px; line-height: 1.5; font-family: '宋体', 'SimSun', serif; }
